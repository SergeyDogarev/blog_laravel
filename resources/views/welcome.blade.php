            ...
            <div class="row">
                <div class="main-slider">
                    <div class="slide-text">
                        ...
                        <a href="{{ route('register') }}" class="btn btn-common">SIGN UP</a>
                    </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="clients-logo wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="col-xs-3 col-sm-2">
                            <a href="#"><img src="{{ asset('images/home/clients1.png') }}" class="img-responsive" alt=""></a>
                        </div>
                        <div class="col-xs-3 col-sm-2">
                            <a href="#"><img src="{{ asset('images/home/clients2.png') }}" class="img-responsive" alt=""></a>
                        </div>
                        <div class="col-xs-3 col-sm-2">
                            <a href="#"><img src="{{ asset('images/home/clients3.png') }}" class="img-responsive" alt=""></a>
                        </div>
                        <div class="col-xs-3 col-sm-2">
                            <a href="#"><img src="{{ asset('images/home/clients4.png') }}" class="img-responsive" alt=""></a>
                        </div>
                        <div class="col-xs-3 col-sm-2">
                            <a href="#"><img src="{{ asset('images/home/clients5.png') }}" class="img-responsive" alt=""></a>
                        </div>
                        <div class="col-xs-3 col-sm-2">
                            <a href="#"><img src="{{ asset('images/home/clients6.png') }}" class="img-responsive" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
