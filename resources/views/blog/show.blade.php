                         ...
                         <div class="col-md-12 col-sm-12">
                            <div class="single-blog blog-details two-column">
                                <div class="post-thumb">
                                    <a href="#"><img src="images/blog/{{ $post->images }}" class="img-responsive" alt=""></a>
                                ...
                                <div class="post-content overflow">
                                    ...
                                    <ul class="media-list">
                                        <li class="media">
                                            <div class="post-comment">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object" src="{{ asset('images/blogdetails/2.png') }}" alt="">
                                                </a>
                                            ...
                                            <div class="parrent">
                                                <ul class="media-list">
                                                    <li class="post-comment reply">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object" src="{{ asset('images/blogdetails/3.png') }}" alt="">
                                                        </a>
                                                        <div class="media-body">
                                                            <span><i class="fa fa-user"></i>Posted by <a href="#">Endure</a></span>
                                        ...
                                        <li class="media">
                                            <div class="post-comment">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object" src="{{ asset('images/blogdetails/4.png') }}" alt="">
                                                </a>
                                                <div class="media-body">
                                                    <span><i class="fa fa-user"></i>Posted by <a href="#">Endure</a></span>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliq Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p>
                    ...
                    <div class="sidebar blog-sidebar">
                        ...
                        <div class="sidebar-item popular">
                            ...
                            <ul class="gallery">
                                ...
                                <li><a href="#"><img src="{{ asset('images/portfolio/popular6.jpg') }}" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
